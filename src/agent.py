...
class Agent:
    ...
    simulation. Contains the double-Q learning algorithm and the two networks to make the
    simulation learn. Contains the memory class en an epsilon-greedy policy class.
    """
